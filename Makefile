MOJISCRIPT_VERSION := $(shell cat MOJISCRIPT_VERSION)
MOJISCRIPT_DEPS := $(wildcard MOJISCRIPT_*)
DOCKER_TAG_PREFIX := rzuckerm/mojiscript:$(MOJISCRIPT_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(MOJISCRIPT_DEPS)
